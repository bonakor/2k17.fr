...
$termslug = $term->slug ?>
  ...
  <h3 class="h6"><?php the_field('age', 'personas_' . $termid);?> ans, <?php the_field('courte_bio', 'personas_' . $termid);?></h3>
...
if( !empty($image) ): ?>
	...
	<figure class="perso-pic"><img class="pic-perso" src="<?php echo $image['url']; ?>" alt="<?php echo $image['alt']; ?>" /></figure></div>
